...
**For example** A picture of log stacks taken with a *"cracked lens"*  This could then be edited to have outlines of birds/squirrels nesting on the broken glass of the lens protector to show how these animals have lost their habitat ^aac6c0
### Shoot plan
- capture a photo using a cracked glass lens protector
	![alt|220](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQFvOkcrwkz5nXD5SQYM3AT_VmEhQtnvEdTXIrfYjf-rw&s=10)
	Using a hammer the glass can be shattered creating something resembling an overlay of a cracked camera lens,
