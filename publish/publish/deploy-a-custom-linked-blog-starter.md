...
First, we want to fork the linked-blog-starter repo, then [[publish/publish/install-linked-blog-starter-locally|install]] and run it locally.

**Note**: Update `https://github.com/matthewwong525/linked-blog-starter` with your own repository link

![[publish/publish/install-linked-blog-starter-locally]]
...
1.  [[publish/publish/publish-your-obsidian-notes-with-linked-blog-starter|Create and publish]] your forked md repository
2. Update the [[publish/publish/update-publish-settings-github-actions|"BLOG_REPO" environment variable]] to point to your forked repo
3. OPTIONAL: [[publish/publish/connect-obsidian-vault-with-github|Connect your Obsidian Vault with Github]]
