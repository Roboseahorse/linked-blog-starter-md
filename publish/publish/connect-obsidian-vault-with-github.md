...
1. Create a repository or [[publish/publish/publish-your-obsidian-notes-with-linked-blog-starter|fork the md repo]] in github
...
![[publish/publish/attachments/create-pat-github.png]]
...
![[publish/publish/attachments/clone-repo-git-plugin.png]]
