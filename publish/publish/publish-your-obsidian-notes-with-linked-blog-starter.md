...
![[publish/publish/attachments/fork-linked-blog-starter-md.png]]
...
![[publish/publish/attachments/configure-project-vercel.png]]
...
![[publish/publish/attachments/disconnect-repo-vercel.png]]
7. Then, [[publish/publish/get-project-id-account-id-and-token-vercel|get the account id, project id and token from vercel]]
...
![[publish/publish/attachments/github-secrets-vercel.png]]
9. Finally, click "Actions", and enable the workflow
![[publish/publish/attachments/enable-actions-github.png]]
...
Optionally, you can:
- [[publish/publish/connect-obsidian-vault-with-github|Publish Notes within your Obsidian Vault]] by installing the Obsidian Git plugin
- [[publish/publish/update-publish-settings-github-actions|Update the publish settings]] to publish your notes to a [[publish/publish/deploy-a-custom-linked-blog-starter|custom version]] of the linked-blog-starter 